...
var ACheckinSDK = (function() {
	...
	ACheckinSDK.setLocalNotification = function(options) {
		ACheckinSDK.validInitSDK();
		return window.ACheckin.handleSDK(
	...
	ACheckinSDK.leaderCheckin = function(options) {
		ACheckinSDK.validInitSDK();
	...
	ACheckinSDK.scanBleDevice = function() {
		ACheckinSDK.validInitSDK();
		return window.ACheckin.handleSDK('scanBleDevice');
	};
	ACheckinSDK.connectBleDevice = function(device_id) {
		ACheckinSDK.validInitSDK();
		return window.ACheckin.handleSDK('connectBleDevice', {
			device_id,
		});
	};
	ACheckinSDK.setPasswordForBleDevice = function(device_id, password) {
		ACheckinSDK.validInitSDK();
		return window.ACheckin.handleSDK('setPasswordForBleDevice', {
			device_id,
			password,
		});
	};
	ACheckinSDK.openBleDevice = function(device_id) {
		ACheckinSDK.validInitSDK();
		return window.ACheckin.handleSDK('openBleDevice', {
			device_id,
		});
	};
	ACheckinSDK.resetBleDevice = function(device_id) {
		ACheckinSDK.validInitSDK();
		return window.ACheckin.handleSDK('resetBleDevice', {
			device_id,
		});
	};
